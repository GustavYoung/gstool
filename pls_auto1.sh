...
#
#
cd /home/uslu/ropongi/uploads/genres/
for dir in */
do
GENRE=$(basename "$dir")
DIR_TO_CHECK="/home/uslu/ropongi/uploads/genres/$GENRE"
PATH_TO_EXCLUDE="/home/uslu/ropongi/uploads/genres/$GENRE/_playlist.m3u"
